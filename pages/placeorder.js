...
function PlaceOrderScreen() {
    ...
    return (
        <Layout title="Finalizar Reserva | CICLO">
            ...
            <Typography variant="h1" component="h1">Finalizar Reserva</Typography>
            <Grid container spacing={1}>
                <Grid item md={9} xs={12}>
                    <Card sx={classes.section}>
                        <List>
                            <ListItem>
                                <Typography variant="h2" component="h2">Metódo de Pagamento</Typography>
                            </ListItem>
                            <ListItem>
                                {paymentMethod}
                            </ListItem>
                    ...
                    <Card sx={classes.section}>
                        <List>
                            <ListItem>
                                <Typography variant="h2" component="h2">Bilhetes Reservados</Typography>
                            </ListItem>
                            <ListItem>
                                <TableContainer>
                                    <Table>
